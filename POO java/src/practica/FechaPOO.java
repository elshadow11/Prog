...
public class FechaPOO implements Comparable<FechaPOO> {
  private int dia;
  private int mes;
  private int anyo;
   ...
   * @param anyo
   */
  public FechaPOO(int dia, int mes, int anyo) {
   ...
   */
  public FechaPOO clona() {
    return new FechaPOO(this.dia, this.mes, this.anyo);
  }
  ...
  public FechaPOO mas1Dia() {
    ...
    return new FechaPOO(dia, mes, anyo);
  }
   ...
   * @return nueva fecha
   */
  public FechaPOO masNDias(int dias) {
    FechaPOO fecha2 = this.clona();
    if (dias>=0) {
   ...
   * @return nueva fecha
   */
  public FechaPOO menosNDias(int dias) {
    FechaPOO fecha2 = this.clona();
    if (dias>=0) {
      for (int i=1; i<=dias; i++) {
        fecha2 = fecha2.menos1Dia();
  ...
  @Override
  public int compareTo(FechaPOO fecha2) {
